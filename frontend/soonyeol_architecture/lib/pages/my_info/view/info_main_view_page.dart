                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            margin:
                                EdgeInsets.only(left: 20, right: 0, bottom: 15),
                            height: 210,
                            width: 190,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            margin:
                                EdgeInsets.only(left: 0, right: 20, bottom: 40),
                            height: 210,
                            width: 200,
                            decoration: const BoxDecoration(
                              color: Color.fromARGB(255, 244, 244, 246),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      controller.completeScenario.value
                                          .toString(),
                                      style: TextStyle(
                                          fontSize: 30,
                                          color: Colors.black,
                      ...
                      Container(
                          margin: EdgeInsets.only(
                              left: Common.getWidth * 0.075,
                              right: Common.getWidth * 0.075),
                          height: 1.0,
                      ...
                      Row(
                        children: [
                          Container(
                            margin: EdgeInsets.only(
                                left: Common.getWidth * 0.085, top: 5),
                            height: 10,
                            width: 10,
                            decoration: const BoxDecoration(
                      ...
                      Padding(
                        ...
                        child: Obx(
                          () => Column(children: [
                            for (int index = 0;
                                index < controller.infoList.length;
                                index++)
                              Column(
                                children: [
                                  if (controller.infoList[index].processivity ==
                                      0)
                                    InfoViewComponent(
                      ...
                      Row(
                        children: [
                          Container(
                            margin: EdgeInsets.only(
                                left: Common.getWidth * 0.085, top: 15),
                            height: 10,
                            width: 10,
                            decoration: const BoxDecoration(
